...
public class EmailSender {
	...
	public boolean sendSimpleMail(String from, String[] to, String subject, String message) {
		...
		if (StringUtils.isEmpty(from)) from = defaultFrom;
		LOG.debug("SendSimpleMail, From: " + from + ", To: " + Arrays.toString(to) + 
		...
		try {
			...
			LOG.debug("Sending email to " + Arrays.toString(to) + " is successfull");
			return true;
		} catch (Exception e) {
	...
	public boolean sendHtmlMail(String from, String to, String subject, String htmlMessage) {
		return sendHtmlMail(from, new String[] {to}, subject, htmlMessage);
	}
	
	public boolean sendHtmlMail(String from, String[] to, String subject, String htmlMessage) {
		if (StringUtils.isEmpty(from)) from = defaultFrom;
		LOG.debug("sendHtmlMail, From: " + from + ", To: " + Arrays.toString(to) + 
				", Subject: " + subject + ", Message: " + htmlMessage);
		try {
	...
	public boolean sendSSLMail(String from, String[] to, String subject, String content) {
		if (StringUtils.isEmpty(from)) from = defaultFrom;
