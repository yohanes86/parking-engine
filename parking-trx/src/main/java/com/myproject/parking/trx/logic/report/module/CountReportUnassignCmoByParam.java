...
public class CountReportUnassignCmoByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(CountReportUnassignCmoByParam.class);
