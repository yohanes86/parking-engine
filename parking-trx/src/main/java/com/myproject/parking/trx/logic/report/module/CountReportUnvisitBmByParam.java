...
public class CountReportUnvisitBmByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(CountReportUnvisitBmByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			int countVisit = reportMapper.countReportUnvisitBm(paramVO);
