...
public class CountReportVisitCmoByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(CountReportVisitCmoByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			int countVisit = reportMapper.countReportVisitCmoByParam(paramVO);
