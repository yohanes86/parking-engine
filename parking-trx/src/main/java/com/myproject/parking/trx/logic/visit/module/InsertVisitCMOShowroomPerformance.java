...
public class InsertVisitCMOShowroomPerformance implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(InsertVisitCMOShowroomPerformance.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			visitMapper.insertVisitCMOShowroomPerformance(showroomPerformance);
