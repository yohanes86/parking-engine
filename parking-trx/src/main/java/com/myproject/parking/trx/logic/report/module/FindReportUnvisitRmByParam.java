...
public class FindReportUnvisitRmByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindReportUnvisitRmByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<ReportUnvisitRmVO> listReportUnvisitRm = reportMapper.findReportUnvisitRm(paramVO);
			return mapper.writeValueAsString(listReportUnvisitRm);
		} catch (Exception e) {
