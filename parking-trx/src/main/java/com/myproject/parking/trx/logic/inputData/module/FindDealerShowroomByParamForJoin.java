...
public class FindDealerShowroomByParamForJoin implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindDealerShowroomByParamForJoin.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<CarBranchDealer> listCarBranchDealer = carBranchDealerMapper.findDealerShowroomByParamForJoin(dealerShowroomParamVO);
