...
public class InsertVisitBmVehicleStockLife implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(InsertVisitBmVehicleStockLife.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			visitMapper.insertVisitBmVehicleStockLife(visitBmVehicleStock);
