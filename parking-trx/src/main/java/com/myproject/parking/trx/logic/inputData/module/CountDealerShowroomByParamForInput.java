...
public class CountDealerShowroomByParamForInput implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(CountDealerShowroomByParamForInput.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			int count = carBranchDealerMapper.countDealerShowroomByParamForInput(dealerShowroomParamVO);
