...
public class CheckProductIdDealerShowroom implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(CheckProductIdDealerShowroom.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			DealerShowroom dealerShowroom = dealerShowroomMapper.checkProductIdDealerShowroom(params);
