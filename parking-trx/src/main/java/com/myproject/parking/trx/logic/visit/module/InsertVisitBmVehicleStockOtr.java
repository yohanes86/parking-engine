...
public class InsertVisitBmVehicleStockOtr implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(InsertVisitBmVehicleStockOtr.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			visitMapper.insertVisitBmVehicleStockOtr(visitBmVehicleStock);
