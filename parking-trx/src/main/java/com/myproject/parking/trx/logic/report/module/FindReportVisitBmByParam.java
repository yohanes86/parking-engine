...
public class FindReportVisitBmByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindReportVisitBmByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<ReportVisitBmVO> listReportVisitBm = reportMapper.findReportVisitBmByParam(paramVO);
			return mapper.writeValueAsString(listReportVisitBm);
		} catch (Exception e) {
