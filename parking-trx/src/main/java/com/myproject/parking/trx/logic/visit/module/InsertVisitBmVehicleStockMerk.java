...
public class InsertVisitBmVehicleStockMerk implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(InsertVisitBmVehicleStockMerk.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			visitMapper.insertVisitBmVehicleStockMerk(visitBmVehicleStock);
