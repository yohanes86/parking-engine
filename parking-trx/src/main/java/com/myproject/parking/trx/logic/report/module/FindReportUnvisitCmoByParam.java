...
public class FindReportUnvisitCmoByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindReportUnvisitCmoByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<ReportUnvisitCmoVO> listReportUnvisitCmo = reportMapper.findReportUnvisitCmo(paramVO);
			return mapper.writeValueAsString(listReportUnvisitCmo);
		} catch (Exception e) {
