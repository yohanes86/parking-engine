...
public class CountNotifAccountInfo implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(CountNotifAccountInfo.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			int countNotifAccInfo = accountInfoMapper.countNotifAccInfo(params);
