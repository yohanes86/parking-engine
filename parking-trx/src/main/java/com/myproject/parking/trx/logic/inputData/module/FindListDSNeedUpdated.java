...
public class FindListDSNeedUpdated implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindListDSNeedUpdated.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<NotifDealerShowroomVO> listDSNeedUpdated = dealerShowroomMapper.findListDealerShowroomNeedUpdated(dealerShowroomParamVO);
			return mapper.writeValueAsString(listDSNeedUpdated);
		} catch (Exception e) {
