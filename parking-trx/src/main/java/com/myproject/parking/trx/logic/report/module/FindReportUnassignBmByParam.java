...
public class FindReportUnassignBmByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindReportUnassignBmByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<ReportUnassignCmoVO> listUnassignBm = reportMapper.findReportUnassign(paramVO);
			return mapper.writeValueAsString(listUnassignBm);
		} catch (Exception e) {
