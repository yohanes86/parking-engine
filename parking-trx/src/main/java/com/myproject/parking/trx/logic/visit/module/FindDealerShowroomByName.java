...
public class FindDealerShowroomByName implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindDealerShowroomByName.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<DealerShowroom> listDealerShowroom = dealerShowroomMapper.findDealerShowroomByName(name);
