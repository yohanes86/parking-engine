...
public class FindReportUnassignCmoByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindReportUnassignCmoByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<ReportUnassignCmoVO> listUnassignCmo = reportMapper.findReportUnassign(paramVO);
			return mapper.writeValueAsString(listUnassignCmo);
		} catch (Exception e) {
