...
public class FindJoinTableByParamVO implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindJoinTableByParamVO.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<DealerShowroom> listDS = joinTableMapper.findJoinTableByParamVO(dealerShowroomParamVO);
			return mapper.writeValueAsString(listDS);
		} catch (Exception e) {
