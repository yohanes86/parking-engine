...
public class UpdateTargetCMOHeader implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(UpdateTargetCMOHeader.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			TargetCMOHeader targetCMOHeader = mapper.readValue(data, TargetCMOHeader.class);	
			targetCMOMapper.updateTargetCMOHeader(targetCMOHeader);
