...
public class FindVisitBmByParam implements SmisBaseQueryLogic {
	private static final Logger LOG = LoggerFactory.getLogger(FindVisitBmByParam.class);
	...
	public String process(String data, ObjectMapper mapper, String pathInfo) {
		...
		try {
			...
			List<ExtVisitRM> listVisitRm = visitMapper.findVisitBmByParam(visit);
